...
function endScreen() {
  ...
  let message = "";
  if (percent >= 90) {
    message = "Excellent! You have a very solid grasp of these concepts.";
  } else if (percent >= 75) {
    message = "Very good! A bit more review will lock this in.";
  } else {
    message = "Almost there. Review missed questions and try again.";
  }

  meta.textContent = "Quiz Complete";
  ...
  card.innerHTML = `
    ...
    <div class="bottombar">
      ...
      <button onclick="shuffleQuestions()">Shuffle & Retry</button>
    </div>
  `;
